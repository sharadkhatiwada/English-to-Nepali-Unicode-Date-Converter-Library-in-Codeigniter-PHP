...
* @link        sharadkhatiwada@gmail.com
*/
	...
	private function get_day_of_week_np($day){		
			switch($day){
				case 1:
					$day = "आइतबार";
					break;
	...
	function eng_to_unicode_characters($str) {
 $r = array(
					'0'=>'०',
					'1'=>'१',
					'2'=>'२',
 ...
 return strtr($str, $r);
		...
		public function AD_to_BS($yy,$mm,$dd){
			if ($this->is_range_eng($yy, $mm, $dd) == false){
				...
				$this->nep_date["year"] = $this->eng_to_unicode_characters($y);
				$this->nep_date["month"] = $m;
				$this->nep_date["date"] = $this->eng_to_unicode_characters($total_nDays);
				$this->nep_date["day"] = $this->get_day_of_week_np($day);
